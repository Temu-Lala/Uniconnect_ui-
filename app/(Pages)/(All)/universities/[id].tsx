...
import { fetchUniversityProfile } from '../../../services/api';
...
const UniversityProfileDetailPage = ({ params }) => {
  ...
  const fetchProfile = async (id) => {
    try {
      ...
      const response = await fetchUniversityProfile(id, token); // Pass the token to the fetchUniversityProfile function
  ...
  return (
    <div className=' pt-48 px-4'>
      <h1 className='text-2xl font-bold mb-4'>University Profile Detail</h1>
      {profile && (
        <div className='mb-4'>
      ...
      <div className='mb-4'>
        <h2 className='text-lg font-bold mb-2'>Rate this university:</h2>
        <input
          type="range"
          min="0"
          max="5"

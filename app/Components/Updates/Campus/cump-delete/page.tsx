...
const DeleteCampusProfile = () => {
  ...
  const handleOk = async () => {
    ...
    try {
      await axios.delete("http://127.0.0.1:8000/campus-profile/delete/", {
        headers: {
  ...
  return (
    <div className="w-full bg-white flex flex-col items-center justify-center p-12">
      <div className="mx-auto w-full md:w-8/12 bg-white p-8 flex justify-center border shadow-lg">
        ...
        >
          <p>Are you sure you want to delete this Campus profile?</p>
        </Modal>
      </div>
    </div>
  );
...
export default DeleteCampusProfile;

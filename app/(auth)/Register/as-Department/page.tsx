...
const NewDepartmentProfileForm = () => {
  const [formData, setFormData] = useState({
    ...
    university_id: '', 
    campus_profile_id: '',
    college_profile_id: '', // Add college_profile_id field
    universities: [],
    campuses: [],
    colleges: [] // Add colleges array
  });
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <label>
          College:
          <select name="college_profile_id" value={formData.college_profile_id} onChange={handleChange}>
        ...
        <button type="submit">Create Department Profile</button>
      </form>
    </div>
  );
};

export default NewDepartmentProfileForm;
